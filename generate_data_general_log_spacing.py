...
# Option 1: Include distribution info in the filename
...
# Choose which option to use (you can use both if desired)
use_option_1 = True
use_option_2 = True
...
if use_option_1:
    ...
    output_file = f"{folder_path}/P_K_log_spaced_{mpf_to_str(x)}.txt"
...
if use_option_2:
    save_metadata(output_file, p, q, x)

print(f"Output saved in file: {output_file}")
if use_option_2:
    print(f"Metadata saved in file: {output_file.rsplit('.', 1)[0] + '_metadata.json'}")
